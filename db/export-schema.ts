...
export const challenges = sqliteTable('challenges', {
    ...
    baronbBuffGoldAdvantageOverThreshold: integer('baron_buffs_gold_advantage_over_threshold'),
    ...
    shortestTimeToAceFromFirstTaledown: integer('shortest_time_to_ace_from_first_takedown'),
...
export const teams = sqliteTable("teams", {
    ...
    teamId: integer("team_id"),
    win: integer("win"),
    atakhanFirst: integer("atakhan_first"),
    atakhanKills: integer("atakhan_kills"),
    ...
    inhibitorKills: integer("inhibitor_kills"),
    riftHeraldFirst: integer("rift_herald_first"),
    riftHeraldKills: integer("rift_herald_kills"),
    voidGrubFirst: integer("void_grub_first"),
    voidGrubKills: integer("void_grub_kills"),
